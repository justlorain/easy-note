...
type BaseResp struct {
	StatusCode    int64  `thrift:"status_code,1" json:"status_code" form:"status_code" query:"status_code"`
	StatusMessage string `thrift:"status_message,2" json:"status_message" form:"status_message" query:"status_message"`
	ServiceTime   int64  `thrift:"service_time,3" json:"service_time" form:"service_time" query:"service_time"`
}
...
type User struct {
	...
	Avatar   string `thrift:"avatar,3" json:"avatar" form:"avatar" query:"avatar"`
}
...
type Note struct {
	NoteID     int64  `thrift:"note_id,1" json:"note_id" form:"note_id" query:"note_id"`
	UserID     int64  `thrift:"user_id,2" json:"user_id" form:"user_id" query:"user_id"`
	Username   string `thrift:"username,3" json:"username" form:"username" query:"username"`
	UserAvatar string `thrift:"user_avatar,4" json:"user_avatar" form:"user_avatar" query:"user_avatar"`
	Title      string `thrift:"title,5" json:"title" form:"title" query:"title"`
	Content    string `thrift:"content,6" json:"content" form:"content" query:"content"`
	CreateTime int64  `thrift:"create_time,7" json:"create_time" form:"create_time" query:"create_time"`
}
...
type CreateUserRequest struct {
	Username string `thrift:"username,1" json:"username" form:"username" query:"username" vd:"len($) > 0"`
	Password string `thrift:"password,2" json:"password" form:"password" query:"password" vd:"len($) > 0"`
}
...
type CreateUserResponse struct {
	BaseResp *BaseResp `thrift:"base_resp,1" json:"base_resp" form:"base_resp" query:"base_resp"`
}
...
type CreateNoteRequest struct {
	Title   string `thrift:"title,1" json:"title" form:"title" query:"title" vd:"len($) > 0"`
	Content string `thrift:"content,2" json:"content" form:"content" query:"content" vd:"len($) > 0"`
	UserID  int64  `thrift:"user_id,3" json:"user_id" form:"user_id" query:"user_id"`
}
...
type QueryNoteRequest struct {
	UserID    int64   `thrift:"user_id,1" json:"user_id" form:"user_id" query:"user_id"`
	SearchKey *string `thrift:"search_key,2,optional" json:"search_key,omitempty" form:"search_key" query:"search_key" vd:"len($) > 0"`
	Offset    int64   `thrift:"offset,3" json:"offset" form:"offset" query:"offset" vd:"len($) >= 0"`
	Limit     int64   `thrift:"limit,4" json:"limit" form:"limit" query:"limit" vd:"len($) >= 0"`
}
...
type QueryNoteResponse struct {
	Notes    []*Note   `thrift:"notes,1" json:"notes" form:"notes" query:"notes"`
	Total    int64     `thrift:"total,2" json:"total" form:"total" query:"total"`
	BaseResp *BaseResp `thrift:"base_resp,3" json:"base_resp" form:"base_resp" query:"base_resp"`
}
...
type UpdateNoteRequest struct {
	NoteID  int64   `thrift:"note_id,1" json:"note_id" form:"note_id" path:"note_id" query:"note_id"`
	UserID  int64   `thrift:"user_id,2" json:"user_id" form:"user_id" query:"user_id"`
	Title   *string `thrift:"title,3,optional" json:"title,omitempty" form:"title" query:"title" vd:"len($) > 0"`
	Content *string `thrift:"content,4,optional" json:"content,omitempty" form:"content" query:"content" vd:"len($) > 0"`
}
