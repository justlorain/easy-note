...
type MGetNoteRequest struct {
	NoteIds []int64 `thrift:"note_ids,1" form:"note_ids" json:"note_ids" query:"note_ids"`
}
...
type NoteServiceMGetNoteArgs struct {
	Req *MGetNoteRequest `thrift:"req,1"`
}
...
type NoteServiceMGetNoteResult struct {
	Success *MGetNoteResponse `thrift:"success,0,optional"`
}
